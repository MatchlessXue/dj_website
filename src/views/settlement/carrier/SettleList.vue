          ...
          <a-row :gutter="24">
            ...
            <a-col :md="6" :sm="24">
              <span class="table-page-search-submitButtons">
                ...
                >查询</a-button>
                <a-button
                  @click="queryParam = { settlementType: 221 }"
      ...
      >
        ...
        >
          ...
          <template v-if="settleType === 301">
            <a @click="$refs.InvoiceModal.add(record.documentId, record.partnerId)">确认收票</a>
          </template>
          <!-- 出纳确认 -->
...
import { getSettleList, deleteSettle, commitSettle, returnSettlement, settlementStatus, enterSettlement, delSettlement } from '@/api/settlement/carrier'
  ...
  data () {
    return {
      ...
      loadData: parameter => {
        ...
        if (find) {
          this.queryParam.partnerId = this.queryParam.partnerId
        } else {
          this.queryParam.partnerName = this.queryParam.partnerId
