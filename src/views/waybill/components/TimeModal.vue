...
export default {
    ...
    timedata: {
      ...
      handler: function (val) {
        ...
        if (this.model) {
          ...
          const { reqDeliveryDate, timeLimit, reqArrivalDate, transportDate } = this.model
          this.form.setFieldsValue({ reqDeliveryDate, timeLimit, reqArrivalDate, transportDate })
  ...
  created () {
    this.settransportDate(this.getToday())
  },
  methods: {
    moment,
