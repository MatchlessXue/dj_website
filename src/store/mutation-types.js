...
export const LOG_COUNT = 'Log_Count' // 控制账号登录出错次数
...
/* dispatch */
export const PRE_DISPATCH_DATA = 'PRE_DISPATCH_DATA'
export const PRE_DISPATCH_FINAL_DATA = 'PRE_DISPATCH_FINAL_DATA'
